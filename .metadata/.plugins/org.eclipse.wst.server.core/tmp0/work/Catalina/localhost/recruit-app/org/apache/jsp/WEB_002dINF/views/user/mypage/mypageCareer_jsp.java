 ...
 * Generated at: 2024-07-14 16:05:01 UTC
...
public final class mypageCareer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("kr.co.sist.user.domain.mypage.UserCareerDomain");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			\r\n");
      out.write("			updateCareerList(true);\r\n");
      out.write("			\r\n");
      out.write("			function getCareerVO() {\r\n");
      out.write("        	    return {\r\n");
      ...
      out.write("        	\r\n");
      out.write("        	\r\n");
      out.write("        	function updateCareerList(isFirst) {\r\n");
      ...
      out.write("			        };\r\n");
      out.write("			    } else {\r\n");
      out.write("			        careerVO = getCareerVO();\r\n");
      out.write("			    }\r\n");
      out.write("			    \r\n");
      out.write("			    $.ajax({\r\n");
      out.write("		            url: \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/api/mypage/getCareer.do\",\r\n");
      ...
      out.write("		                    $(\"#careerTable tbody\").html('<tr><td colspan=\"4\">요청하신 결과가 없습니다.</td></tr>');\r\n");
      out.write("		                } \r\n");
      out.write("		            },\r\n");
      out.write("		            error: function(xhr, status, error) {\r\n");
      out.write("		                console.error(\"Error fetching data: \" + error);\r\n");
      out.write("		                $(\"#careerTable tbody\").html('<tr><td colspan=\"4\">데이터를 불러오는 데 실패했습니다.</td></tr>');\r\n");
      out.write("		            }\r\n");
      out.write("		        });\r\n");
      out.write("		    }//function\r\n");
      out.write("		    \r\n");
      out.write("		    function populateTable(careerList) {\r\n");
      out.write("	            var tableBody = $(\"#careerTable tbody\");\r\n");
      out.write("	            tableBody.empty();\r\n");
      out.write("	            $.each(careerList, function(index, companyInfo) {\r\n");
      out.write("	            	\r\n");
      out.write("	                var logoCell = $('<td class=\"tableHeader\">').append(\r\n");
      out.write("	                    $('<img>').attr({\r\n");
      out.write("	                        src: 'http://localhost/recruit-app/assets/images/company/logo/' + companyInfo.logo,\r\n");
      out.write("	                        style: 'width: 70px; height: 70px;'\r\n");
      out.write("	                    })\r\n");
      out.write("	                );\r\n");
      out.write("\r\n");
      out.write("	                var companyInfoCell = $('<td class=\"companyInfo\">').append(\r\n");
      out.write("	                    $('<h1 class=\"companyInfo\" style=\"font-size: 18px;\"><strong>').text(companyInfo.companyName),\r\n");
      out.write("	                    $('<ul class=\"companyInfo\">').append(\r\n");
      out.write("	                        $('<li>').text('매출액 ' + companyInfo.revenue + '억'),\r\n");
      out.write("	                        $('<li>').text('사원수 ' + companyInfo.headcount + '명') \r\n");
      out.write("	                    )\r\n");
      out.write("	                );\r\n");
      out.write("\r\n");
      out.write("	                var buttonCell = $('<td class=\"tableHeader\">').append(\r\n");
      out.write("	                    $('<input type=\"button\">').attr({\r\n");
      out.write("	                        name: 'writeRivew',\r\n");
      out.write("	                        class: 'btn btn-outline-success btn-sm register-btn',\r\n");
      out.write("	                        value: '리뷰 작성',\r\n");
      out.write("	                        onclick: \"location.href='http://localhost/recruit-app/review/reviewWrite.do?companyCode=\" + companyInfo.companyCode + \"';\"\r\n");
      out.write("	                    })\r\n");
      out.write("	                );\r\n");
      out.write("\r\n");
      out.write("	                var row = $('<tr class=\"tableMiddle\">').append(logoCell, companyInfoCell, buttonCell);\r\n");
      out.write("	                tableBody.append(row);\r\n");
      out.write("	            });//each\r\n");
      out.write("	    	}//function\r\n");
      out.write("	    	\r\n");
      out.write("	    	\r\n");
      out.write("		    function countApplyList(careerVO){\r\n");
      out.write("        		$.ajax({\r\n");
      out.write("                    url: \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/api/mypage/careerCount.do\",\r\n");
      out.write("                    method: 'GET',\r\n");
      out.write("                    data: careerVO,\r\n");
      out.write("                    dataType: 'JSON',\r\n");
      ...
      out.write("                    updateCareerList(false);\r\n");
      ...
      out.write("            <h1 style=\"font-size: 25px;\"><strong>커리어</strong></h1>\r\n");
      out.write("			<!--// tap menu -->\r\n");
      out.write("			<div class=\"mtcTplTab\" >\r\n");
      out.write("				<ul class=\"tabItems\">\r\n");
      out.write("					<li class=\"on\"><a href=\"mypageCareer.do\">나의 커리어</a></li>\r\n");
      out.write("					<li class=\"\"><a href=\"mypageReview.do\">나의 리뷰</a></li>\r\n");
      out.write("				</ul>\r\n");
      out.write("			</div>\r\n");
      out.write("			<!-- tap menu //-->\r\n");
      out.write("				<div style=\"margin-top: 30px;\">\r\n");
      out.write("					<label>나의 재직 기업</label>\r\n");
      out.write("				</div>\r\n");
      out.write("				<div>\r\n");
      ...
      out.write("					<table id=\"careerTable\">\r\n");
      out.write("						<tbody>\r\n");
      out.write("						</tbody>\r\n");
      out.write("					</table>\r\n");
      out.write("                </div>\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/user/mypage/mypageCareer.jsp(340,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
