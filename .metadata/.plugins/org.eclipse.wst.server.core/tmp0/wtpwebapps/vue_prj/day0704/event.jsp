...
<div>
    <div id="app">
        ...
        <input type="button" value="더블클릭" class="btn btn-sm btn-success" v-on:dblClick="handleDbClick"/>
        <input type="text" placeholder="엔터를 치면 동작" v-on:keydown.enter="handleEnter"/>
        <input type="text" value="clip board 이벤트" v-on:copy="handleClip"/>
...
<script type="text/javascript">
    new Vue({
        ...
        methods:{
            ...
            handleSubmit(){
                alert("폼이 서브밋 이벤트 발생시킴"+this.formValue);
            }
        }
    });
</script>
