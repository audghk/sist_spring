			...
			<section class="Section_Section__P1hhc">
				...
				<div>
					<div class="loungeContent noticeListContent"
						style="width: 100%; max-width: 1300px; margin: 30px auto; box-sizing: border-box; padding: 20px;">
							...
							<form action="#">
								...
								<fieldset>
									...
									<div class="searchBarItem mtcPlaceholder" style="float: right">
										<span class="phTx"></span> <input type="text" id="lb_sch"
											class="mtcSchInp" title="검색어 입력">
										<!-- <input type="button" class="mtcBtnB mtcSchBtn" value="검색"/> -->
										<button type="button" id="searchBtn" class="mtcBtnB mtcSchBtn">
										...
										<c:forEach var="notice" items="${noticeList}">
											<tr class=primary>
												...
												<td class="alLeft"><span class="tit"><a
														href="http://localhost/recruit-app/notice/detail.do?notice_num=${notice.notice_num}"><c:out
																value="${notice.title}" /></a></span></td>
												<td class="date"><fmt:formatDate
														value="${notice.input_date}" pattern="yyyy-MM-dd" /></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
									        ...
									        <nav aria-label="...">
									            <ul class="pagination pagination-lg" style="display: inline-flex;">
									                <c:choose>
									                    ...
									                    <c:otherwise>
									                        <li class="page-item"><a class="page-link" href="?currentPage=${currentPage - 1}&itemsPerPage=${searchVO.itemsPerPage}">&lt;</a></li>
									                    </c:otherwise>
									                </c:choose>
