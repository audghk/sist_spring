             ...
             <div class="section_group"> 
              <section class="content_ty4 video_ad_content" data-content_type="review" data-content_id="3038782" data-company_id="361411"> 
               <div class="content_wrap"> 
                <div class="content_top_ty2"> <span class="ico_pers"></span> <span class="txt1">영업/제휴</span> <span class="vbar">|</span> <span class="txt1"> 현직원 </span> <span class="vbar">|</span> <span class="txt1">서울</span> <span class="vbar">|</span> <span class="txt1">2022. 05</span> 
                </div> 
                <div class="ctbody_col2"> 
                 <dl class="ctbody_lft"> 
                  <dd class="sta_box"> 
                   <div class="us_star_m"> 
                    <div class="star_score" style="width:80%;">
                     평점
                    </div> 
                   </div> 
                  </dd> 
                  ...
                  <dd class="blo_box1"> 
                   <div class="us_bl_s"> 
                    <div class="bl_score" style="width:100%;">
                     평점
                    </div> 
                   </div> 
                  </dd> 
                  ...
                  <dd class="blo_box1"> 
                   <div class="us_bl_s"> 
                    <div class="bl_score" style="width:60%;">
                     평점
                    </div> 
                   </div> 
                  </dd> 
                  ...
                  <dd class="blo_box1"> 
                   <div class="us_bl_s"> 
                    <div class="bl_score" style="width:80%;">
                     평점
                    </div> 
                   </div> 
                  </dd> 
                 ...
                 <div class="content_body_ty1"> 
                  <div class="us_label_wrap"> 
                   <h2 class="us_label "> <span class="us_label_box">BEST</span> "완벽한 회사는 아니고 부족한 점도 많지만, 어쨌든 미래를 보고 다니는 회사" </h2> 
                  </div> 
                  <dl class="tc_list"> 
                   <dt class="merit">
                    장점
                   </dt> 
                   <dd class="df1"> <span>- 글로벌 진출이라는게 이런 것이구나 라는 것을 체감할 수 있음. 많을 때는 회사의 1/3은 해외 어딘가에 나가있는 듯. <br>- 해외영업/기술영업에 뜻이 있고, sales-driven한 환경에서 제품 개발에도 참여하면서 커리어를 발전시키고 싶다면 생각해 볼만한 환경임. <br>- 딜을 성사시킨 것이 실물로 나타나고 눈 앞에서 작동하는 것을 볼 때의 쾌감이 있음.</span> 
                   </dd> 
                   <dt class="disadvantages">
                    단점
                   </dt> 
                   <dd class="df1"> <span>- 유연함의 이면에 감춰진 혼란함. 이젠 규모가 꽤 되는데, 아직도 갖춰지지 않은게 많음. <br>- 다른 리뷰에서 언급된 탁구대, 다트는 이미 예전에 없어졌고, 회사 규모가 커지면서 자연스럽게 한 팀으로 돌아갈 수 있는 시기는 지난 듯. 조금씩이지만 계속 나아지고는 있는 건 다행이랄까. <br>- 분야가 조금 특수하기 때문에 자신이랑 안 맞는다고 느끼기 쉬울 듯. 새로운 분야에서 빠르게 학습하며 새로운 스킬셋을 쌓는다고 생각하고 많이 공부하고 노력해야 함.</span> 
                   </dd> 
                   <dt class="df_tit">
                    경영진에 바라는 점
                   </dt> 
                   <dd class="df1"> <span>아직 스타트업이라고 하지만 이제 규모도 꽤 커졌고, 현 직원들과 지원자들이 회사를 바라보는 관점과 기대치도 달라지고 있습니다. 기술과 사업이 확장되는 만큼 체계를 갖추고 조직을 안정화하는 일에도 더 많은<br> 신경을 써주세요.</span> 
                   </dd> 
                   <dd style="display: flex; justify-content: flex-end; margin-top: 20px;"> <button type="button" class="btn btn-dark">추천</button> 
                   </dd> 
                  </dl> 
                 </div> 
                </div> 
