...
<div>
	...
	<div>
    	<ul>
    		...
    		<li><a href="day0610/use_redirect.do">Controller를 통해서 redirect로 JSP호출</a></li>
    		<li><a href="day0610/use_redirect2.do">Controller를 통해서 day0605/hsr_hs.do 호출</a></li>
    	</ul>
    </div>
    <div>
    	<ul>
    ...
    <div>
    	<ul>
    		...
    		<li><a href="day0610/temp.do">temp.do요청</a></li>
    ...
    <div>
    	<ul>
    		...
    		<li><a href="day0610/remove_session.do">HttpSession 세션 사용종료(삭제안됨)</a></li>
    		<li><a href="day0610/remove_session2.do">SessionStatus 세션 사용종료</a></li>
    	</ul>
    </div>
    <div>
    	<ul>
    ...
    <div>
    	<ul>
    		<li><a href="day0611/test_exception.do">Controller에 예외 발생</a></li>
    		<li><a href="day0611/test_exception2.do">Controller에 예외 발생2</a></li>
    	</ul>
    </div>
    <div>
        <ul>
