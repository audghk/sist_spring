...
<script type="text/javascript">
	$(function(){
		$("#btnSingle").click(function(){
			$("#frmGet")[0].action="get_single_param.do";
			$("#frmGet").submit();
		});//click
		...
		$("#btnVo").click(function(){
			$("#frmGet")[0].action="../day0605/get_vo_param.do";
			$("#frmGet").submit();
		});//click
		...
		$("#btnHsr").click(function(){
			$("#frmGet")[0].action="../day0605/get_hsr_param.do";
			$("#frmGet").submit();
		});//click
		...
		$("#btnRp").click(function(){
			$("#frmGet")[0].action="../day0605/get_btn_rp.do";
			$("#frmGet").submit();
		});//click
		$("#btnRpVO").click(function(){
			$("#frmGet")[0].action="../day0605/get_btn_rp_vo.do";
			$("#frmGet").submit();
		});//click
	});//ready
</script>
