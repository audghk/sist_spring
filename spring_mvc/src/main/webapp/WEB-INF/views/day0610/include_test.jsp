...
<!-- URL로 설정되면 parameter를 받을 수 없다. -->
<c:import url="http://localhost/spring_mvc/common/jsp/header.jsp"/>
<c:import url="http://localhost${ pageContext.request.contextPath }/common/jsp/header.jsp"/> <!-- ${ pageContext.request.contextPath } => /spring_mvc -->
