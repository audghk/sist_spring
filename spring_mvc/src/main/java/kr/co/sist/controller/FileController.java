...
public class FileController {
    ...
    public String uploadFrm() {
        return "day0613/upload_frm";
    }
    
    @PostMapping("/day0613/upload_process.do")
    //1. HttpServletRequest받기
    public String uploadProcess(HttpServletRequest request,String temp, Model model) throws IOException {
     ...
     // 2. 파일 업로드 클래스 생성
        MultipartRequest mr = new MultipartRequest(request, saveDir.getAbsolutePath(), tempSize,
